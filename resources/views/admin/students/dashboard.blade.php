        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-xl font-semibold mb-4">Ringkasan Data Siswa</h3>
                    <p class="mb-6">Selamat datang di dashboard admin siswa. Berikut adalah daftar lengkap siswa beserta detail pendaftaran dan hasil ujian mereka.</p>
                            ...
                            <tbody>
                                @forelse ($studentsData as $student)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="py-4 px-6">
                                            {{ $student['pilihan_jurusan_1'] ?? '-' }}
                                        </td>
                                        <td class="py-4 px-6">
                                            {{ $student['pilihan_jurusan_2'] ?? '-' }}
                                        </td>
                                        <td class="py-4 px-6">
                                            {{ $student['skor_tkd'] }}
                                        </td>
                                        ...
                                        <td class="py-4 px-6">
                                            {{ $student['skor_minat_bakat'] }}
                                        </td>
                                        <td class="py-4 px-6 font-bold">
                                            {{ $student['total_skor'] }}
                                        </td>
                                        <td class="py-4 px-6">
                                            {{ $student['rekomendasi_jurusan'] }}
                                        </td>
                                        {{-- <td class="py-4 px-6">
